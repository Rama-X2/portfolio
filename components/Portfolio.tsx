  ...
  return (
    <div className="min-h-screen portfolio-bg text-white flex flex-col">
      ...
      <div className="flex flex-1 pt-[60px] md:pt-[72px] justify-center">
        {/* ── Content ─── */}
        <main ref={mainRef} className="flex-1 max-w-6xl mx-auto w-full p-3 md:p-6 lg:p-8 min-w-0 space-y-12 md:space-y-16">
          ...
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-5">
              {projects.map((project) => (
                ...
                >
                  {/* Project image */}
                  <div className="relative h-40 sm:h-44 overflow-hidden bg-[#160d35]">
                    <Image src={project.image} alt={project.title} fill
                      className="object-cover" />
                    <div className="absolute inset-0 bg-gradient-to-t from-[#160d35] via-[#160d35]/40 to-transparent pointer-events-none z-10" />
